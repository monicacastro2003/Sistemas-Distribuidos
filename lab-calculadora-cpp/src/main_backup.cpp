...
// HTML básico inline (CORRETAMENTE formatado)
...
void handle_request(http::request<http::string_body>& req, http::response<http::string_body>& res) {
    ...
    if (target == "/" || target == "/index.html") {
        ...
        // Extrai números da URL: /somar/10/5
        size_t pos1 = 7; // tamanho de "/somar/"
        ...
        if (pos2 != std::string::npos) {
            ...
            res.result(http::status::bad_request);
            res.body() = "Formato invalido. Use: /somar/num1/num2";
        }
    }
        ...
        if (pos2 != std::string::npos) {
            ...
            res.result(http::status::bad_request);
            res.body() = "Formato invalido. Use: /subtrair/num1/num2";
        }
    }
        ...
        if (pos2 != std::string::npos) {
            ...
            res.result(http::status::bad_request);
            res.body() = "Formato invalido. Use: /multiplicar/num1/num2";
        }
    }
        ...
        if (pos2 != std::string::npos) {
            ...
            res.result(http::status::bad_request);
            res.body() = "Formato invalido. Use: /dividir/num1/num2";
        }
    }
    else {
